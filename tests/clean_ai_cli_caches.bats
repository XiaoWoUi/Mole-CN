...
EOF
    ...
    assert_run_success
    assert_output_not_contains "Codex CLI 状态"
...
EOF
    ...
    assert_run_success
    assert_output_not_contains "Antigravity/Gemini 缓存 · 已跳过"
...
EOF
    ...
    assert_run_success
    assert_output_contains "SAFE_CLEAN:Claude Desktop 内置 Claude Code 旧版本|$claude_support/claude-code/2.1.140"
    assert_output_contains "SAFE_CLEAN:Claude Desktop 内置 Claude Code VM 旧版本|$claude_support/claude-code-vm/2.1.140"
...
EOF
    ...
    assert_run_success
    assert_output_contains "SAFE_CLEAN:Claude Desktop 内置 Claude Code 旧版本|$claude_support/claude-code/2.1.142"
    assert_output_contains "SAFE_CLEAN:Claude Desktop 内置 Claude Code VM 旧版本|$claude_support/claude-code-vm/2.1.142"
...
EOF
    ...
    assert_run_success
    assert_output_not_contains "Claude Desktop 内置 Claude Code"
    assert_output_not_contains "SAFE_CLEAN:"
}
...
EOF
    ...
    assert_run_success
    assert_output_contains "· 已跳过(活动版本未知)"
    assert_output_not_contains "SAFE_CLEAN:"
}
...
EOF
    ...
    assert_run_success
    assert_output_not_contains "UNEXPECTED_DELETE"
    assert_output_contains "Claude Code 旧版本 · 已停止(保留策略已更改)"
}
...
EOF
    ...
    assert_run_success
    assert_output_not_contains "UNEXPECTED_DELETE"
    assert_output_contains "Claude Code 旧版本 · 已停止(活动版本已更改)"
}
...
EOF
    ...
    assert_run_success
    assert_output_not_contains "UNEXPECTED_DELETE"
    assert_output_contains "stopped (活动版本已更改)"
}
...
EOF
    ...
    assert_run_success
    assert_output_not_contains "UNEXPECTED_DELETE"
    assert_output_contains "stopped (保留策略已更改)"
}
