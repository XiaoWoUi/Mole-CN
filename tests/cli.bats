...
EOF
	...
	run env HOME="$HOME" "$PROJECT_ROOT/mole" --version
	[ "$status" -eq 0 ]
	[[ "$output" == *"Mole 版本 $expected_version"* ]] || return 1
	[[ "$output" == *"频道: 夜间版"* ]]
}
